...
def sample_transactions() -> List[Dict[str, Any]]:
    ...
    return [
        ...
        {
            'Дата операции': '05.02.2023 09:45:00',
            'Категория': 'Рестораны',
            'Кэшбэк': 200.0
        },
        {
            'Дата операции': '10.01.2023 18:20:00',
            'Категория': 'Супермаркеты',
            'Кэшбэк': 75.3
        }
    ]
    ...
    test_data = [
        {
            ...
            'Категория': 'Тест',
            'Кэшбэк': 123.9  # Should be converted to 123
        },
        {
            'Дата операции': '02.01.2023 00:00:00',
            'Категория': 'Тест',
            'Кэшбэк': 456.1  # Should be converted to 456
        }
    ]
    test_year = 2023
    test_month = 1
